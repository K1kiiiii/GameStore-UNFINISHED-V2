...
public class DataSeeder {
    ...
    // Seed podaci za lokalni razvoj i demo.
    // Ovaj bean ubacuje sample igre i recenzije samo ako tabela igara trenutno nema zapisa.
    // Nemojte automatski izvršavati ovo u produkciji bez provjere okruženja.
    @Bean
    CommandLineRunner initDatabase(GameRepository gameRepository, ReviewRepository reviewRepository) {
        return args -> {
            if (gameRepository.count() == 0) {
                ...
                // Add sample reviews for a few games
                ...
                // Add a few reviews specifically for Hades (g4)
                Review r7 = new Review();
                r7.setAuthor("Ava");
                r7.setContent("Fast-paced runs, gorgeous art direction and a great progression loop.");
                r7.setRating(5);
                r7.setGame(g4);
                ...
                r8.setAuthor("Ben");
                r8.setContent("Loved the soundtrack and combat; runs feel meaningful.");
                r8.setRating(5);
                r8.setGame(g4);
                ...
                r9.setAuthor("Riley");
                r9.setContent("Short runs are perfect for quick play sessions. A must-play.");
                r9.setRating(4);
                r9.setGame(g4);
                reviewRepository.save(r9);

                System.out.println("✅ Sample games and reviews seeded successfully.");
