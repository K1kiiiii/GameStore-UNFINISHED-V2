...
public class PublisherController {
    ...
    public String newPublisherForm(Model model) {
        // Dodajemo prazan Publisher objekat u model radi Thymeleaf form-bindinga
    ...
    public String updatePublisher(@PathVariable Long id, @ModelAttribute Publisher publisher) {
        // Dohvatamo postojeći entitet i ažuriramo polja umjesto direktnog spremanja payload-a
        // kako bismo spriječili nenamjerno prebrisavanje nepopunjenih polja iz forme.
