...
public class AdminController {
    ...
    // Admin endpoint za reset i ponovno punjenje baze sa sample podacima.
    // PAŽNJA: Ovaj endpoint briše sve podatke i treba biti zaštićen u produkciji.
    @PostMapping("/seed")
    public ResponseEntity<String> seedDatabase() {
        // Clear existing data
        // Brišemo prvo recenzije pa igre zbog FK ograničenja (reviews imaju foreign key prema game).
        ...
        // Add Hades (g4) so reseed includes it with reviews
        Game g4 = new Game();
        g4.setTitle("Hades");
